...
//var base_url="http://localhost/framesgallery/collage/show/";
var url = window.location.href;
var a = url.split("/");
var base_url = a[0] + "/" + a[1] + "/" + a[2] + "/" + a[3] + "/collage/show/";
...
jQuery(document).ready(function () {
    ...
    jQuery('#fileupload').fileupload({
        ...
        success: function (data) {
            ...
            jQuery('<li class="ui-draggable"><img class="img-thumbnail" id=' + data[1] + ' src="../../sites/all/modules/frames/frames_temp/' + file_name + '" rel="../../sites/all/modules/frames/frames_temp/' + file_name + '" width="50px" height="50px"><div class="c-image-remove" title="Remove image"></div></li>')
//                        .attr('class', 'ui-draggable')
//                        .find('img')
//                        .attr('src', '../frames_temp/'+file_name)
//                        .attr('rel', '../frames_temp/'+file_name)
//                        .attr('width', 50)
//                        .attr('height', 50)
...
//salman search
    ...
    if (slot_id == 4) {
        $("#slot_4").val(cData["cslots"][cpos]["img"]);
        $('#slot_4_details').val(box_id);
    }
    if (slot_id == 5) {
        $("#slot_5").val(cData["cslots"][cpos]["img"]);
        $('#slot_5_details').val(box_id);
    }
    if (slot_id == 6) {
        $("#slot_6").val(cData["cslots"][cpos]["img"]);
        $('#slot_6_details').val(box_id);
    }
    if (slot_id == 7) {
        $("#slot_7").val(cData["cslots"][cpos]["img"]);
        $('#slot_7_details').val(box_id);
    }
    if (slot_id == 8) {
        $("#slot_8").val(cData["cslots"][cpos]["img"]);
        $('#slot_8_details').val(box_id);
    }
    if (slot_id == 9) {
        $("#slot_9").val(cData["cslots"][cpos]["img"]);
        $('#slot_9_details').val(box_id);
    }
    if (slot_id == 10) {
        $("#slot_10").val(cData["cslots"][cpos]["img"]);
        $('#slot_10_details').val(box_id);
    }
    if (slot_id == 11) {
        $("#slot_11").val(cData["cslots"][cpos]["img"]);
        $('#slot_11_details').val(box_id);
    }
    if (slot_id == 12) {
        $("#slot_12").val(cData["cslots"][cpos]["img"]);
        $('#slot_12_details').val(box_id);
    }
    if (slot_id == 13) {
        $("#slot_13").val(cData["cslots"][cpos]["img"]);
        $('#slot_13_details').val(box_id);
    }
    if (slot_id == 14) {
        $("#slot_14").val(cData["cslots"][cpos]["img"]);
        $('#slot_14_details').val(box_id);
    }
    if (slot_id == 15) {
        $("#slot_15").val(cData["cslots"][cpos]["img"]);
        $('#slot_15_details').val(box_id);
    }
    if (slot_id == 16) {
        $("#slot_16").val(cData["cslots"][cpos]["img"]);
        $('#slot_16_details').val(box_id);
    }
    if (slot_id == 17) {
        $("#slot_17").val(cData["cslots"][cpos]["img"]);
        $('#slot_17_details').val(box_id);
    }
    if (slot_id == 18) {
        $("#slot_18").val(cData["cslots"][cpos]["img"]);
        $('#slot_18_details').val(box_id);
    }
    if (slot_id == 19) {
        $("#slot_19").val(cData["cslots"][cpos]["img"]);
        $('#slot_19_details').val(box_id);
    }
    if (slot_id == 20) {
        $("#slot_20").val(cData["cslots"][cpos]["img"]);
        $('#slot_20_details').val(box_id);
    }
    if (slot_id == 21) {
        $("#slot_21").val(cData["cslots"][cpos]["img"]);
        $('#slot_21_details').val(box_id);
    }
    if (slot_id == 22) {
        $("#slot_22").val(cData["cslots"][cpos]["img"]);
        $('#slot_22_details').val(box_id);
    }
    if (slot_id == 23) {
        $("#slot_23").val(cData["cslots"][cpos]["img"]);
        $('#slot_23_details').val(box_id);
    }
    if (slot_id == 24) {
        $("#slot_24").val(cData["cslots"][cpos]["img"]);
        $('#slot_24_details').val(box_id);
    }
    if (slot_id == 25) {
        $("#slot_25").val(cData["cslots"][cpos]["img"]);
        $('#slot_25_details').val(box_id);
    }
    box_id = "";
    slot_id = "";
...
function initJcrop(slot) {
//   var frame_width=slot.width();
//   var frme_height=slot.height();
    ...
    //jcrop_api.setSelect([ pos_x2 , pos_y2 , frame_width , frme_height]);
    ...
    $("#c-designer-modal-crop-confirm").click(function () {
        ...
        var a = coordinates(jcrop_api.tellScaled());
        var cor = a.split("_");
        if (slot_id == 'c-slot-1') {
            $("#slot_1_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-2') {
            $("#slot_2_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-3') {
            $("#slot_3_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-4') {
            $("#slot_4_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-5') {
            $("#slot_5_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-6') {
            $("#slot_6_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-7') {
            $("#slot_7_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-8') {
            $("#slot_8_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-9') {
            $("#slot_9_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-10') {
            $("#slot_10_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-11') {
            $("#slot_11_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-12') {
            $("#slot_12_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-13') {
            $("#slot_13_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-14') {
            $("#slot_14_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-15') {
            $("#slot_15_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-16') {
            $("#slot_16_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-17') {
            $("#slot_17_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-18') {
            $("#slot_18_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-19') {
            $("#slot_19_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-20') {
            $("#slot_20_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-21') {
            $("#slot_21_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-22') {
            $("#slot_22_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-23') {
            $("#slot_23_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-24') {
            $("#slot_24_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
        if (slot_id == 'c-slot-25') {
            $("#slot_25_de").val(cor[0] + "_" + cor[2] + "_" + cor[1] + "_" + cor[3]);
        }
...
//    asif crop panga 
    if ((c.h != cropImgData["cropImgH"]) || (c.w != cropImgData["cropImgW"])) {
        slotImg.css("left", offsetLeftCss + "px");
        slotImg.css("top", offsetTopCss + "px");
    } else if ((c.h == cropImgData["cropImgH"]) && (c.w == cropImgData["cropImgW"])) {
...
function collageEmptyCheck() {
    if ($('.c-layout-slot img').length == 0) {
//       asif search for remove coridinates
