...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 31 && ($img_w1 == $img_h1) && isset($_POST['slot_1_de'])) {
    ...
    } else if ($f_id == 31 && ($img_w1 > $img_h1) && isset($_POST['slot_1_de'])) {
        $newwidth = $img_w1 * 1.01;
        $newheight = $img_h1 * 1.01;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image1);
        // Resize
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image1);
    } else if ($f_id == 35 && ($img_w1 < $img_h1) && isset($_POST['slot_1_de'])) {
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 31 && ($img_w2 == $img_h2) && isset($_POST['slot_2_de'])) {
    ...
    }else if ($f_id == 35 && ($img_w2 < $img_h2) && isset($_POST['slot_2_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image2);
    } else if ($f_id == 31 && ($img_w2 > $img_h2) && isset($_POST['slot_2_de'])) {
        $newwidth = $img_w2 * 1.01;
        $newheight = $img_h2 * 1.01;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image2);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 31 && ($img_w3 == $img_h3) && isset($_POST['slot_3_de'])) {
    ...
    } else if ($f_id == 31 && ($img_w3 > $img_h3) && isset($_POST['slot_3_de'])) {
        $newwidth = $img_w3 * 1.01;
        $newheight = $img_h3 * 1.01;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image3);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 35 && ($img_w4 == $img_h4)) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image4);
    } else if ($f_id == 31 && ($img_w4 == $img_h4)) {
        $newwidth = $img_w4 * 1.7;
        $newheight = $img_h4 * 1.7;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image4);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 31 && ($img_w5 == $img_h5) && isset($_POST['slot_5_de'])) {
        $newwidth = $img_w5 * 1.02;
        $newheight = $img_h5 * 1.02;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
    ...
    } else if ($f_id == 31 && ($img_w5 > $img_h5) && isset($_POST['slot_5_de'])) {
        $newwidth = $img_w5 * 1.01;
        $newheight = $img_h5 * 1.01;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image5);
        // Resize
    ...
    if ($f_id == 35 && ($img_w5 == $img_h5)) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image5);
    } else if ($f_id == 32 && ($img_w5 == $img_h5)) {
        $newwidth = $img_w5 * 1.6;
        $newheight = $img_h5 * 1.6;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image5);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 31 && ($img_w6 == $img_h6) && isset($_POST['slot_6_de'])) {
        $newwidth = $img_w6 * 1.02;
        $newheight = $img_h6 * 1.02;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
    ...
    }else if ($f_id == 35 && ($img_w6 < $img_h6) && isset($_POST['slot_6_de'])) {
        $newwidth = $img_w6 * 1.06;
        $newheight = $img_h6 * 1.06;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image6);
        // Resize
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image6);
    } else if ($f_id == 31 && ($img_w6 > $img_h6) && isset($_POST['slot_6_de'])) {
        $newwidth = $img_w6 * 1.01;
        $newheight = $img_h6 * 1.01;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image6);
        // Resize
    ...
    if ($f_id == 32 && ($img_w6 == $img_h6)) {
        $newwidth = $img_w6 * 1.6;
        $newheight = $img_h6 * 1.6;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image6);
        // Resize
...
if ($width7 < $height7) {
    $image->new_width = $box_width7 / 2;
} else {
    $image->new_height = $box_height7 / 2;
}
...
if ($process['result'] && $image->save_folder) {
    ...
    $box7_width = intval($box_width7 / 2);
    $box7_height = intval($box_height7 / 2);
    if ($f_id == 31 && ($img_w7 == $img_h7) && isset($_POST['slot_7_de'])) {
        $newwidth = $img_w7 * 1.02;
        $newheight = $img_h7 * 1.02;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
    ...
    } else if ($f_id == 35 && ($img_w7 < $img_h7) && isset($_POST['slot_7_de'])) {
        $newwidth = $img_w7 * 1.06;
        $newheight = $img_h7 * 1.06;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image7);
        // Resize
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image7);
    }else if ($f_id == 31 && ($img_w7 > $img_h7) && isset($_POST['slot_7_de'])) {
        $newwidth = $img_w7 * 1.01;
        $newheight = $img_h7 * 1.01;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image7);
        // Resize
    ...
    if ($f_id == 32 && ($img_w7 == $img_h7)) {
        ...
        $newwidth = $box_width7 / 2;
        $newheight = $img_h7 + ($diff / 2);
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image7);
        // Resize
        ...
        $newheight = $box_height7 / 2;
        $newwidth = $img_w7 + ($diff / 2);
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image7);
        // Resize
...
if ($f_id == '31') {
    ...
    if (isset($_POST['slot_7_de']) && ($_POST['slot_7_de'] != "")) {
        ...
        $pos_h7 = $slot_7_de[2];
        if ($pos_w7 > ($pos_w7 / 2)) {
            $pos_w7 = $slot_7_de[0] * 3.8;
        } else if ($pos_w7 < ($pos_w7 / 2)) {
            $pos_w7 = $slot_7_de[0] * 3;
        }
        if ($pos_w7 > ($pos_w7 / 2)) {
            $pos_w7 = $slot_7_de[0] * 1.9;
        } else if ($pos_w7 < ($pos_w7 / 2)) {
            $pos_w7 = $slot_7_de[0] * 3;
        }
        if ($pos_h7 > ($pos_h7 / 2)) {
            ...
            if ($image_h7 > $image_w7) {
                ...
                $pos_h = $slot_7_de[2] * 6.2;
            }
        } else if ($pos_h7 < ($pos_h7 / 2)) {
            $pos_h2 = $slot_2_de[2] * 3;
        }
    } else {
        list($image_w7, $image_h7) = getimagesize($new_image7);
...
imagecopy($canvas, $icon7, $box_x7 / 2, $box_y7 / 2, $pos_w7, $pos_h7, $box_width7 / 2, $box_height7 / 2);
