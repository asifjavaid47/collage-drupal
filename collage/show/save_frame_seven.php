...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 33 && $img_w1 == $img_h1 && isset($_POST['slot_1_de'])) {
        $newwidth = $img_w1 * 1.1;
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image1);
    } else if ($f_id == 30 && ($img_w1 == $img_h1) && isset($_POST['slot_1_de'])) {
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 29 && ($img_w2 < $img_h2)) {
        $newwidth = $img_w2 * 1.05;
        $newheight = $img_h2 * 1.05;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
    ...
    } else if ($f_id == 33 && ($img_w2 == $img_h2)) {
        $newwidth = $img_w2 * 1.4;
        $newheight = $img_h2 * 1.4;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image2);
        // Resize
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image2);
    } else if ($f_id == 29 && ($img_w2 == $img_h2)) {
        $newwidth = $img_w2 * 1.03;
        $newheight = $img_h2 * 1.03;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image2);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    } else if ($f_id == 34 && ($img_w3 < $img_h3) && $_POST['slot_3_de']) {
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 30 && ($img_w4 < $img_h4)) {
    ...
    } else if ($f_id == 34 && ($img_w4 < $img_h4) && $_POST['slot_4_de']) {
        $newwidth = $img_w4 * 1.07;
        $newheight = $img_h4 * 1.07;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image4);
        // Resize
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image4);
    } else if ($f_id == 44 && ($img_w4 == $img_h4) && $_POST['slot_4_de']) {
        $newwidth = $img_w4 * 1.6;
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 34 && ($img_w5 == $img_h5)) {
    ...
    } else if ($f_id == 34 && ($img_w5 < $img_h5) && $_POST['slot_5_de']) {
        $newwidth = $img_w5 * 1.07;
        $newheight = $img_h5 * 1.07;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image5);
        // Resize
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image5);
    } else if ($f_id == 54 && ($img_w5 == $img_h5) && $_POST['slot_5_de']) {
        $newwidth = $img_w5 * 1.6;
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 29 && ($img_w6 < $img_h6)) {
        $newwidth = $img_w6 * 1.05;
        $newheight = $img_h6 * 1.05;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 33 && $img_w7 == $img_h7) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image7);
    } else if ($f_id == 30 && ($img_w7 == $img_h7) && isset($_POST['slot_7_de'])) {
        $newwidth = $img_w7 * 1.05;
        $newheight = $img_h7 * 1.05;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image7);
        // Resize
