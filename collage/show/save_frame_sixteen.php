...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 64 && ($img_w1 < $img_h1) && isset($_POST['slot_1_de'])) {
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 64 && ($img_w2 < $img_h2) && isset($_POST['slot_2_de'])) {
        $newwidth = $img_w2 * 1;
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 64 && ($img_w3 < $img_h3) && isset($_POST['slot_3_de'])) {
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 65 && ($img_w6 == $img_h6)) {
        $newwidth = $img_w6 * 1.7;
        $newheight = $img_h6 * 1.7;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 65 && ($img_w7 == $img_h7)) {
        $newwidth = $img_w7 * 1.4;
        $newheight = $img_h7 * 1.4;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 64 && ($img_w8 == $img_h8)) {
        $newwidth = $img_w8 * 1.65;
        $newheight = $img_h8 * 1.65;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
    ...
    } else if ($f_id == 65 && ($img_w8 == $img_h8)) {
        $newwidth = $img_w8 * 1.7;
        $newheight = $img_h8 * 1.7;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image8);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 65 && ($img_w12 == $img_h12)) {
        $newwidth = $img_w12 * 1.55;
        $newheight = $img_h12 * 1.55;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 65 && ($img_w13 == $img_h13)) {
        $newwidth = $img_w13 * 1.5;
        $newheight = $img_h13 * 1.5;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 64 && ($img_w14 < $img_h14) && isset($_POST['slot_14_de'])) {
    ...
    } else if ($f_id == 64 && ($img_w14 == $img_h14)) {
        $newwidth = $img_w14 * 1.5;
        $newheight = $img_h14 * 1.5;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image14);
        // Resize
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image14);
    } else if ($f_id == 65 && ($img_w14 == $img_h14)) {
        $newwidth = $img_w14 * 1.5;
        $newheight = $img_h14 * 1.5;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 64 && ($img_w15 < $img_h15) && isset($_POST['slot_15_de'])) {
    ...
    } else if ($f_id == 64 && ($img_w15 == $img_h15)) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image15);
    } else if ($f_id == 65 && ($img_w15 < $img_h15)) {
        $newwidth = $img_w15 * 1;
        $newheight = $img_h15 * 1;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 64 && ($img_w16 < $img_h16) && isset($_POST['slot_16_de'])) {
    ...
    } else if ($f_id == 64 && ($img_w16 == $img_h16)) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image16);
    } else if ($f_id == 65 && ($img_w16 < $img_h16)) {
        $newwidth = $img_w16 * 1;
        $newheight = $img_h16 * 1;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
...
if ($f_id == '63') {
    ...
    if (isset($_POST['slot_2_de']) && ($_POST['slot_2_de'] != "")) {
        ...
        if ($pos_w2 > ($pos_w2 / 2)) {
            ...
            if ($image_h2 == $image_w2) {
                $pos_w2 = $slot_2_de[0] * 1.34;
            }
            //width greater
            if ($image_h2 < $image_w2) {
                $pos_w2 = $slot_2_de[0] * 1.42;
            }
        }
        //height
        if ($pos_h2 > ($pos_h2 / 2)) {
    ...
    if (isset($_POST['slot_3_de']) && ($_POST['slot_3_de'] != "")) {
        ...
        if ($pos_w3 > ($pos_w3 / 2)) {
            ...
            if ($image_h3 == $image_w3) {
                $pos_w3 = $slot_3_de[0] * 1.28;
            }
            //width greater
            if ($image_h3 < $image_w3) {
                $pos_w3 = $slot_3_de[0] * 1.33;
            }
        }
        //height
        if ($pos_h3 > ($pos_h3 / 2)) {
    ...
    if (isset($_POST['slot_15_de']) && ($_POST['slot_15_de'] != "")) {
        ...
        if ($pos_h15 > ($pos_h15 / 2)) {
            ...
            //graeter
            if ($image_h15 > $image_w15) {
                $pos_h15 = $pos_h15 * 1.36;
            }
            //equal
            if ($image_h15 == $image_w15) {
                $pos_h15 = $pos_h15 * 1.05;
            }
        }
    } else {
        list($image_w15, $image_h15) = getimagesize($new_image15);
    ...
    if (isset($_POST['slot_16_de']) && ($_POST['slot_16_de'] != "")) {
        ...
        if ($pos_w16 > ($pos_w16 / 2)) {
            ...
            if ($image_h16 == $image_w16) {
                $pos_w16 = $slot_16_de[0] * 1.28;
            }
            //width greater
            if ($image_h16 < $image_w16) {
                $pos_w16 = $slot_16_de[0] * 1.33;
            }
        }
        //height
        if ($pos_h16 > ($pos_h16 / 2)) {
            ...
            //graeter
            if ($image_h16 > $image_w16) {
                $pos_h16 = $pos_h16 * 1.51;
            }
            //equal
            if ($image_h16 == $image_w16) {
                $pos_h16 = $pos_h16 * 1.05;
            }
        }
    } else {
        list($image_w16, $image_h16) = getimagesize($new_image16);
...
if ($f_id == '65') {
    ...
    if (isset($_POST['slot_3_de']) && ($_POST['slot_3_de'] != "")) {
        ...
        if ($pos_w3 > ($pos_w3 / 2)) {
            list($image_w3, $image_h3) = getimagesize($new_image3);
            if ($image_h3 == $image_w3) {
                $pos_w3 = $slot_3_de[0] * 1.38;
            }
            //width greater
            if ($image_h3 < $image_w3) {
                $pos_w3 = $slot_3_de[0] * 1.45;
            }
        }
        //height
        if ($pos_h3 > ($pos_h3 / 2)) {
    ...
    if (isset($_POST['slot_11_de']) && ($_POST['slot_11_de'] != "")) {
        ...
        if ($pos_w11 > ($pos_w11 / 2)) {
            list($image_w11, $image_h11) = getimagesize($new_image11);
            if ($image_h11 == $image_w11) {
                $pos_w11 = $slot_11_de[0] * 1.1;
            }
            //width greater
            if ($image_h11 < $image_w11) {
                $pos_w11 = $slot_11_de[0] * 1.2;
            }
        }
        //height
        if ($pos_h11 > ($pos_h11 / 2)) {
    ...
    if (isset($_POST['slot_13_de']) && ($_POST['slot_13_de'] != "")) {
        ...
        if ($pos_h13 > ($pos_h13 / 2)) {
            ...
            //graeter
            if ($image_h13 > $image_w13) {
                $pos_h13 = $pos_h13 * 1.55;
            }
            //equal
            if ($image_h13 == $image_w13) {
                $pos_h13 = $pos_h13 * 1.05;
            }
        }
    } else {
        list($image_w13, $image_h13) = getimagesize($new_image13);
        ...
        if ($pos_h14 > ($pos_h14 / 2)) {
            ...
            //graeter
            if ($image_h14 > $image_w14) {
                $pos_h14 = $pos_h14 * 1.55;
            }
            //equal
            if ($image_h14 == $image_w14) {
                $pos_h14 = $pos_h14 * 1.02;
            }
        }
    } else {
        list($image_w14, $image_h14) = getimagesize($new_image14);
...
if (isset($_POST['frame_text']) && (!empty($_POST['frame_text']))) {
    ...
    if ($f_id == '63') {
        ...
        $img->setPosition("center", "2055");
        $img->setTextColor(0, 0, 0);
        $img->setQuality(100);
    } else if ($f_id == '65') {
        $img->setPosition("center", "2375");
        $img->setTextColor(0, 0, 0);
        $img->setQuality(100);
    } else if ($f_id == '66'){
        $img->setPosition("center", "2058");
        $img->setTextColor(0, 0, 0);
        $img->setQuality(100);
    }
