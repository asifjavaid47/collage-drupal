...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 40 && $img_w1 == $img_h1) {
    ...
    } else if ($f_id == 43 && $img_w1 < $img_h1 && isset($_POST['slot_1_de'])) {
        $newwidth = $img_w1 * 1.025;
        $newheight = $img_h1 * 1.025;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image1);
        // Resize
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image1);
    } else if ($f_id == 44 && $img_w1 == $img_h1) {
        $newwidth = $img_w1 * 1.41;
        $newheight = $img_h1 * 1.41;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image1);
        // Resize
...
//        imagejpeg($thumb, '../frames_resize/' . $new_image1);
//    } 
    else if ($f_id == 39 && $img_w1 < $box1_width) {
...
if ($process['result'] && $image->save_folder) {
    ...
    } else if ($f_id == 43 && $img_w2 < $img_h2 && isset($_POST['slot_2_de'])) {
        $newwidth = $img_w2 * 1.025;
        $newheight = $img_h2 * 1.025;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image2);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 39 && $img_w3 == $img_h3) {
    ...
    } else if ($f_id == 43 && $img_w3 < $img_h3 && isset($_POST['slot_3_de'])) {
        $newwidth = $img_w3 * 1.025;
        $newheight = $img_h3 * 1.025;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image3);
        // Resize
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image3);
    }else if ($f_id == 44 && $img_w3 == $img_h3) {
        $newwidth = $img_w3 * 1.41;
        $newheight = $img_h3 * 1.41;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image3);
        // Resize
    ...
    else if ($f_id == 41 && $img_w3== $img_h3) {
        $newwidth = $img_w3 * 1.61;
        $newheight = $img_h3 * 1.61;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image3);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    } else if ($f_id == 43 && $img_w4 < $img_h4 && isset($_POST['slot_4_de'])) {
        $newwidth = $img_w4 * 1.025;
        $newheight = $img_h4 * 1.025;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image4);
        // Resize
...
//    }
        ...
        $newwidth = $img_w4 * 1.41;
        $newheight = $img_h4 * 1.41;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image4);
        // Resize
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image4);
    } else if ($f_id == 41 && $img_w4 == $img_h4) {
        $newwidth = $img_w4 * 1.61;
        $newheight = $img_h4 * 1.61;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image4);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 42 && $img_w5 == $img_h5) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image5);
    } else if ($f_id == 43 && $img_w5 < $img_h5 && isset($_POST['slot_5_de'])) {
        $newwidth = $img_w5 * 1.025;
        $newheight = $img_h5 * 1.025;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image5);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 42 && $img_w6 == $img_h6) {
        $newwidth = $img_w6 * 1.51;
        $newheight = $img_h6 * 1.51;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
    ...
    } else if ($f_id == 43 && $img_w6 < $img_h6 && isset($_POST['slot_6_de'])) {
        $newwidth = $img_w6 * 1.025;
        $newheight = $img_h6 * 1.025;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image6);
        // Resize
...
//    else if ($f_id == 44 && $img_w6 < $img_h6) {
//        $newwidth = $img_w6 * 1.08;
//        $newheight = $img_h6 * 1.08;
//        // Load
//        $thumb = imagecreatetruecolor($newwidth, $newheight);
//        $source = imagecreatefromjpeg($new_image6);
//        // Resize
...
//    }
        ...
        $newwidth = $img_w6 * 1.41;
        $newheight = $img_h6 * 1.41;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image6);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    } else if ($f_id == 43 && $img_w7 < $img_h7 && isset($_POST['slot_7_de'])) {
        $newwidth = $img_w7 * 1.025;
        $newheight = $img_h7 * 1.025;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image7);
        // Resize
...
//    else if ($f_id == 44 && $img_w7 < $img_h7) {
//        $newwidth = $img_w7 * 1.08;
//        $newheight = $img_h7 * 1.08;
//        // Load
//        $thumb = imagecreatetruecolor($newwidth, $newheight);
//        $source = imagecreatefromjpeg($new_image7);
//        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    } else if ($f_id == 43 && $img_w8 < $img_h8 && isset($_POST['slot_8_de'])) {
        $newwidth = $img_w8 * 1.025;
        $newheight = $img_h8 * 1.025;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image8);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    } else if ($f_id == 43 && $img_w9 < $img_h9 && isset($_POST['slot_9_de'])) {
        $newwidth = $img_w9 * 1.025;
        $newheight = $img_h9 * 1.025;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image9);
        // Resize
...
//    else if ($f_id == 44 && $img_w9 < $img_h9) {
//        $newwidth = $img_w9 * 1.08;
//        $newheight = $img_h9 * 1.08;
//        // Load
//        $thumb = imagecreatetruecolor($newwidth, $newheight);
//        $source = imagecreatefromjpeg($new_image9);
//        // Resize
...
//    }
        ...
        $newwidth = $img_w9 * 1.41;
        $newheight = $img_h9 * 1.41;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image9);
        // Resize
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image9);
    } else if ($f_id == 39 && $img_w9 == $img_h9) {
        $newwidth = $img_w9 * 1.35;
        $newheight = $img_h9 * 1.35;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image9);
        // Resize
...
if ($f_id == '39') {
    ...
    if (isset($_POST['slot_5_de']) && ($_POST['slot_5_de'] != "")) {
        ...
        if ($pos_w5 > ($pos_w5 / 2)) {
            ...
            if ($image_h5 == $image_w5) {
                $pos_w5 = $slot_5_de[0] - 10;
            }
            //width greater
            if ($image_h5 < $image_w5) {
                $pos_w5 = $slot_5_de[0] * 1.01;
            }
        }
        //height
        if ($pos_h5 > ($pos_h5 / 2)) {
    ...
    if (isset($_POST['slot_6_de']) && ($_POST['slot_6_de'] != "")) {
        ...
        if ($pos_w6 > ($pos_w6 / 2)) {
            ...
            if ($image_h6 == $image_w6) {
                $pos_w6 = $slot_6_de[0] - 10;
            }
            //width greater
            if ($image_h6 < $image_w6) {
                $pos_w6 = $slot_6_de[0] * 1.01;
            }
        }
        //height
        if ($pos_h6 > ($pos_h6 / 2)) {
    ...
    if (isset($_POST['slot_3_de']) && ($_POST['slot_3_de'] != "")) {
        ...
        if ($pos_w3 > ($pos_w3 / 2)) {
            list($image_w3, $image_h3) = getimagesize($new_image3);
            if ($image_h3 == $image_w3) {
                $pos_w3 = $slot_3_de[0] * 0.84;
            }
            //width greater
            if ($image_h3 < $image_w3) {
                $pos_w3 = $slot_3_de[0] * 0.92;
            }
        }
        //height
        if ($pos_h3 > ($pos_h3 / 2)) {
    ...
    if (isset($_POST['slot_4_de']) && ($_POST['slot_4_de'] != "")) {
        ...
        if ($pos_w4 > ($pos_w4 / 2)) {
            list($image_w4, $image_h4) = getimagesize($new_image4);
            if ($image_h4 == $image_w4) {
                $pos_w4 = $slot_4_de[0] * 0.84;
            }
            //width greater
            if ($image_h4 < $image_w4) {
                $pos_w4 = $slot_4_de[0] * 0.92;
            }
        }
        //height
        if ($pos_h4 > ($pos_h4 / 2)) {
    ...
    if (isset($_POST['slot_1_de']) && ($_POST['slot_1_de'] != "")) {
        ...
        if ($pos_w1 > ($pos_w1 / 2)) {
            list($image_w1, $image_h1) = getimagesize($new_image1);
            if ($image_h1 == $image_w1) {
                $pos_w1 = $slot_1_de[0] * 2.02;
            }
            //width greater
            if ($image_h1 < $image_w1) {
                $pos_w1 = $slot_1_de[0] * 2.04;
            }
        }
        //height
        if ($pos_h1 > ($pos_h1 / 2)) {
    ...
    if (isset($_POST['slot_9_de']) && ($_POST['slot_9_de'] != "")) {
        ...
        if ($pos_w9 > ($pos_w9 / 2)) {
            list($image_w9, $image_h9) = getimagesize($new_image9);
            if ($image_h9 == $image_w9) {
                $pos_w9 = $slot_9_de[0] *  2.02;
            }
            //width greater
            if ($image_h9 < $image_w9) {
                $pos_w9 = $slot_9_de[0] * 2.04;
            }
        }
        //height
        if ($pos_h9 > ($pos_h9 / 2)) {
    ...
    if (isset($_POST['slot_2_de']) && ($_POST['slot_2_de'] != "")) {
        ...
        if ($pos_w2 > ($pos_w2 / 2)) {
            list($image_w2, $image_h2) = getimagesize($new_image2);
            if ($image_h2 == $image_w2) {
                $pos_w2 = $slot_2_de[0] * 1.3;
            }
            //width greater
            if ($image_h2 < $image_w2) {
                $pos_w2 = $slot_2_de[0] * 1.36;
            }
        }
        //height
        if ($pos_h2 > ($pos_h2 / 2)) {
    ...
    if (isset($_POST['slot_7_de']) && ($_POST['slot_7_de'] != "")) {
        ...
        if ($pos_w7 > ($pos_w7 / 2)) {
            list($image_w7, $image_h7) = getimagesize($new_image7);
            if ($image_h7 == $image_w7) {
                $pos_w7 = $slot_7_de[0] * 1.3;
            }
            //width greater
            if ($image_h7 < $image_w7) {
                $pos_w7 = $slot_7_de[0] * 1.36;
            }
        }
        //height
        if ($pos_h7 > ($pos_h7 / 2)) {
    ...
    if (isset($_POST['slot_5_de']) && ($_POST['slot_5_de'] != "")) {
        ...
        //height
        if ($pos_h5 > ($pos_h5 / 2)) {
            list($image_w5, $image_h52) = getimagesize($new_image52);
            //graeter
            if ($image_h5 > $image_w2) {
                $pos_h2 = $pos_h52 * 1.62;
            }
            //equal
            if ($image_h5 == $image_w5) {
...
if (isset($_POST['frame_text']) && (!empty($_POST['frame_text']))) {
    ...
    if ($f_id == '39') {
        ...
        $img->setPosition("center", "2330");
        $img->setTextColor(0, 0, 0);
        $img->setQuality(100);
    } else if ($f_id == '41') {
        $img->setPosition("center", "1710");
        $img->setTextColor(0, 0, 0);
        $img->setQuality(100);
    } else if ($f_id == '42') {
        $img->setPosition("center", "1740");
        $img->setTextColor(0, 0, 0);
        $img->setQuality(100);
    } else if ($f_id == '43') {
        $img->setPosition("center", "1600");
