...
if ($process['result'] && $image->save_folder) {
    ...
    $box1_height = intval($box_height1 / 4);
     ...
     if ($f_id == 68 && ($img_w1 < $img_h1) && isset($_POST['slot_1_de'])) {
    ...
    }else if ($f_id == 69 && ($img_w1 < $img_h1) && isset($_POST['slot_1_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image1);
    }else if ($f_id == 68 && ($img_w1 == $img_h1)) {
        $newwidth = $img_w1 * 1.54;
        $newheight = $img_h1 * 1.54;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image1);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 68 && ($img_w3 < $img_h3) && isset($_POST['slot_3_de'])) {
    ...
    } else  if ($f_id == 69 && ($img_w3 < $img_h3) && isset($_POST['slot_3_de'])) {
    ...
    else if ($f_id == 68 && ($img_w3 == $img_h3)) {
        $newwidth = $img_w3 * 1.54;
        $newheight = $img_h3 * 1.54;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image3);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 68 && ($img_w4 < $img_h4) && isset($_POST['slot_4_de'])) {
    ...
    }else if ($f_id == 69 && ($img_w4 < $img_h4) && isset($_POST['slot_4_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image4);
    }else if ($f_id == 68 && ($img_w4 == $img_h4)) {
        $newwidth = $img_w4 * 1.54;
        $newheight = $img_h4 * 1.54;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image4);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 68 && ($img_w5 < $img_h5) && isset($_POST['slot_5_de'])) {
    ...
    } else if ($f_id == 69 && ($img_w5 < $img_h5) && isset($_POST['slot_5_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image5);
    } else if ($f_id == 68 && ($img_w5 == $img_h5)) {
        $newwidth = $img_w5 * 1.54;
        $newheight = $img_h5 * 1.54;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image5);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 68 && ($img_w6 < $img_h6) && isset($_POST['slot_6_de'])) {
    ...
    }else  if ($f_id == 69 && ($img_w6 < $img_h6) && isset($_POST['slot_6_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image6);
    }else if ($f_id == 68 && ($img_w6 == $img_h6)) {
        $newwidth = $img_w6 * 1.54;
        $newheight = $img_h6 * 1.54;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image6);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 68 && ($img_w7 < $img_h7) && isset($_POST['slot_7_de'])) {

        $newwidth = $img_w7 * 1;
        $newheight = $img_h7 * 1.1;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
    ...
    }else if ($f_id == 69 && ($img_w7 < $img_h7) && isset($_POST['slot_7_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image7);
    }else if ($f_id == 68 && ($img_w7 == $img_h7)) {
        $newwidth = $img_w7 * 1.54;
        $newheight = $img_h7 * 1.54;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image7);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 68 && ($img_w8 < $img_h8) && isset($_POST['slot_8_de'])) {
    ...
    }else if ($f_id == 69 && ($img_w8 < $img_h8) && isset($_POST['slot_8_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image8);
    } else if ($f_id == 68 && ($img_w8 == $img_h8)) {
        $newwidth = $img_w8 * 1.54;
        $newheight = $img_h8 * 1.54;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image8);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 68 && ($img_w9 < $img_h9) && isset($_POST['slot_9_de'])) {

        $newwidth = $img_w9 * 1;
        $newheight = $img_h9 * 1.1;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
    ...
    }else  if ($f_id == 69 && ($img_w9 < $img_h9) && isset($_POST['slot_9_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image9);
    }else if ($f_id == 68 && ($img_w9 == $img_h9)) {
        $newwidth = $img_w9 * 1.54;
        $newheight = $img_h9 * 1.54;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image9);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 68 && ($img_w10 < $img_h10) && isset($_POST['slot_10_de'])) {

        $newwidth = $img_w10 * 1;
        $newheight = $img_h10 * 1.1;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
    ...
    }else if ($f_id == 69 && ($img_w10 < $img_h10) && isset($_POST['slot_10_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image10);
    }else if ($f_id == 68 && ($img_w10 == $img_h10)) {
        $newwidth = $img_w10 * 1.54;
        $newheight = $img_h10 * 1.54;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image10);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 68 && ($img_w11 < $img_h11) && isset($_POST['slot_11_de'])) {

        $newwidth = $img_w11 * 1;
        $newheight = $img_h11 * 1.1;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
    ...
    }else  if ($f_id == 69 && ($img_w11 < $img_h11) && isset($_POST['slot_11_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image11);
    }else if ($f_id == 68 && ($img_w11 == $img_h11)) {

        $newwidth = $img_w11 * 1.54;
        $newheight = $img_h11 * 1.54;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image11);
        // Resize
...
if ($f_id == 68 && ($img_w12 < $img_h12) && isset($_POST['slot_12_de'])) {

        $newwidth = $img_w12 * 1;
        $newheight = $img_h12 * 1.1;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
    ...
    }else if ($f_id == 69 && ($img_w12 < $img_h12) && isset($_POST['slot_12_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image12);
    }else if ($f_id == 68 && ($img_w12 == $img_h12)) {

        $newwidth = $img_w12 * 1.54;
        $newheight = $img_h12 * 1.54;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image12);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 68 && ($img_w13 < $img_h13) && isset($_POST['slot_13_de'])) {

        $newwidth = $img_w13 * 1;
        $newheight = $img_h13 * 1.1;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
    ...
    }else if ($f_id == 69 && ($img_w13 < $img_h13) && isset($_POST['slot_13_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image13);
    }else if ($f_id == 68 && ($img_w13 == $img_h13) ) {

        $newwidth = $img_w13 * 1.54;
        $newheight = $img_h13 * 1.54;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image13);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 68 && ($img_w14 < $img_h14) && isset($_POST['slot_14_de'])) {

        $newwidth = $img_w14 * 1;
        $newheight = $img_h14 * 1.1;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
    ...
    }else if ($f_id == 69 && ($img_w14 < $img_h14) && isset($_POST['slot_14_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image14);
    }else  if ($f_id == 68 && ($img_w14 == $img_h14)) {

        $newwidth = $img_w14 * 1.54;
        $newheight = $img_h14 * 1.54;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image14);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 68 && ($img_w15 < $img_h15) && isset($_POST['slot_15_de'])) {
    ...
    }else if ($f_id == 69 && ($img_w15 < $img_h15) && isset($_POST['slot_15_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image15);
    }else if ($f_id == 68 && ($img_w15 == $img_h15)) {

        $newwidth = $img_w15 * 1.54;
        $newheight = $img_h15 * 1.54;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image15);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 68 && ($img_w16 < $img_h16) && isset($_POST['slot_16_de'])) {
    ...
    }else if ($f_id == 69 && ($img_w16 < $img_h16) && isset($_POST['slot_16_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image16);
    }else if ($f_id == 68 && ($img_w16 == $img_h16)) {

        $newwidth = $img_w16 * 1.54;
        $newheight = $img_h16 * 1.54;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image16);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 68 && ($img_w17 < $img_h17) && isset($_POST['slot_17_de'])) {
    ...
    }else if ($f_id == 69 && ($img_w17 < $img_h17) && isset($_POST['slot_17_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image17);
    }else  if ($f_id == 68 && ($img_w17 == $img_h17)) {
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 68 && ($img_w18 < $img_h18) && isset($_POST['slot_18_de'])) {
    ...
    }else if ($f_id == 69 && ($img_w18 < $img_h18) && isset($_POST['slot_18_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image18);
    }else if ($f_id == 68 && ($img_w18 == $img_h18)) {

        $newwidth = $img_w18 * 1.54;
        $newheight = $img_h18 * 1.54;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image18);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 68 && ($img_w19 < $img_h19) && isset($_POST['slot_19_de'])) {

        $newwidth = $img_w19 * 1;
        $newheight = $img_h19 * 1.1;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
    ...
    }else if ($f_id == 69 && ($img_w19 < $img_h19) && isset($_POST['slot_19_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image19);
    }else if ($f_id == 68 && ($img_w19 == $img_h19)) {
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 68 && ($img_w20 < $img_h20) && isset($_POST['slot_20_de'])) {

        $newwidth = $img_w20 * 1;
        $newheight = $img_h20 * 1.1;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
    ...
    }else if ($f_id == 69 && ($img_w20 < $img_h20) && isset($_POST['slot_20_de'])) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image20);
    }else if ($f_id == 68 && ($img_w20 == $img_h20)) {

        $newwidth = $img_w20 * 1.54;
        $newheight = $img_h20 * 1.54;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image20);
        // Resize
    ...
    if (isset($_POST['slot_19_de']) && ($_POST['slot_19_de'] != "")) {
        ...
        if ($pos_w19 > ($pos_w19 / 2)) {
            ...
            if ($image_h19 == $image_w19) {
                $pos_w19 = $slot_19_de[0] * 1.28;
            }
            //width greater
            if ($image_h19 < $image_w19) {
                $pos_w19 = $slot_19_de[0] * 5;
            }
        }
        //height
    ...
    if (isset($_POST['slot_20_de']) && ($_POST['slot_20_de'] != "")) {
        ...
        if ($pos_w20 > ($pos_w20 / 2)) {
            ...
            if ($image_h20 == $image_w20) {
                $pos_w20 = $slot_20_de[0] * 1.28;
            }
            //width greater
            if ($image_h20 < $image_w20) {
                $pos_w20 = $slot_20_de[0] * 5;
            }
        }
        //height
...
if ($f_id == '70') {
    ...
    if (isset($_POST['slot_13_de']) && ($_POST['slot_13_de'] != "")) {
        ...
        if ($pos_w14 > ($pos_w14 / 2)) {
            list($image_w14, $image_h14) = getimagesize($new_image14);
            if ($image_h14 == $image_w14) {
                $pos_w14 = $slot_14_de[0] * 1.04;
            }
            //width greater
            if ($image_h14 < $image_w14) {
                $pos_w14 = $slot_14_de[0] *  1.02;
            }
        }
        //height
        if ($pos_h14 > ($pos_h14 / 2)) {
    ...
    if (isset($_POST['slot_15_de']) && ($_POST['slot_15_de'] != "")) {
        ...
        if ($pos_w15 > ($pos_w15 / 2)) {
            list($image_w15, $image_h15) = getimagesize($new_image15);
            if ($image_h15 == $image_w15) {
                $pos_w15 = $slot_15_de[0] * 1.04;
            }
            //width greater
            if ($image_h15 < $image_w15) {
                $pos_w15 = $slot_15_de[0] * 1.02;
            }
        }
        //height
        if ($pos_h15 > ($pos_h15 / 2)) {
    ...
    if (isset($_POST['slot_16_de']) && ($_POST['slot_16_de'] != "")) {
        ...
        if ($pos_w16 > ($pos_w16 / 2)) {
            list($image_w16, $image_h16) = getimagesize($new_image16);
            if ($image_h16 == $image_w16) {
                $pos_w16 = $slot_16_de[0] * 1.04;
            }
            //width greater
            if ($image_h16 < $image_w16) {
                $pos_w16 = $slot_16_de[0] * 1.02;
            }
        }
        //height
        if ($pos_h16 > ($pos_h16 / 2)) {
     ...
     if (isset($_POST['slot_17_de']) && ($_POST['slot_17_de'] != "")) {
        ...
        if ($pos_w17 > ($pos_w17 / 2)) {
            list($image_w17, $image_h17) = getimagesize($new_image17);
            if ($image_h17 == $image_w17) {
                $pos_w17 = $slot_17_de[0] * 1.04;
            }
            //width greater
            if ($image_h17 < $image_w17) {
                $pos_w17 = $slot_17_de[0] * 1.02;
            }
        }
        //height
        if ($pos_h17 > ($pos_h17 / 2)) {
     ...
     if (isset($_POST['slot_18_de']) && ($_POST['slot_18_de'] != "")) {
        ...
        if ($pos_w18 > ($pos_w18 / 2)) {
            list($image_w18, $image_h18) = getimagesize($new_image18);
            if ($image_h18 == $image_w18) {
                $pos_w18 = $slot_18_de[0] * 1.04;
            }
            //width greater
            if ($image_h18 < $image_w18) {
                $pos_w18 = $slot_18_de[0] * 1.02;
            }
        }
        //height
        if ($pos_h18 > ($pos_h18 / 2)) {
    ...
    if (isset($_POST['slot_19_de']) && ($_POST['slot_19_de'] != "")) {
        ...
        if ($pos_w19 > ($pos_w19 / 2)) {
            list($image_w19, $image_h19) = getimagesize($new_image19);
            if ($image_h19 == $image_w19) {
                $pos_w19 = $slot_19_de[0] *1.04;
            }
            //width greater
            if ($image_h19 < $image_w19) {
                $pos_w19 = $slot_19_de[0] * 1.02;
            }
        }
        //height
        if ($pos_h19 > ($pos_h19 / 2)) {
    ...
    if (isset($_POST['slot_20_de']) && ($_POST['slot_20_de'] != "")) {
        ...
        if ($pos_w20 > ($pos_w20 / 2)) {
            list($image_w20, $image_h20) = getimagesize($new_image20);
            if ($image_h20 == $image_w20) {
                $pos_w20 = $slot_20_de[0] * 1.04;
            }
            //width greater
            if ($image_h20 < $image_w20) {
                $pos_w20 = $slot_20_de[0] * 1.02;
            }
        }
        //height
        if ($pos_h20 > ($pos_h20 / 2)) {
...
if (isset($_POST['frame_text']) && (!empty($_POST['frame_text']))) {
    ...
    if ($f_id == '68') {
        ...
        $img->setPosition("center", "2540");
        $img->setTextColor(0, 0, 0);
        $img->setQuality(100);
    }else if ($f_id == '73') {
        $img->setPosition("center", "1800");
        $img->setTextColor(0, 0, 0);
        $img->setQuality(100);
    }
