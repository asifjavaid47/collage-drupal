...
class textPainter{
     ...
     * @access public
     */
    public function show($path_to_save){
    	//show thumb
		...
		switch ($this->format){
			case "JPEG":
				imagejpeg($this->img,$path_to_save,$this->jpegQuality);
				break;
			case "PNG":
				imagepng($this->img,$path_to_save);
				break;
			case "GIF":
				imagegif($this->img,$path_to_save);
				break;
			case "WBMP":
				imagewbmp($this->img,$path_to_save);
				break;
			default:
				imagepng($this->img,$path_to_save);
		}
