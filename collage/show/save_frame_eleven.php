...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 58 && $img_w1 < $img_h1) {
        
        $newwidth = $img_w1 * 1.38;
        $newheight = $img_h1 *1.38;
        // Load
   ...
   else if ($f_id == 56 && $img_w1 == $img_h1) {
        $newwidth = $img_w1 * 1.4;
        $newheight = $img_h1 * 1.4;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        $source = imagecreatefromjpeg($new_image1);
        // Resize
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 57 && $img_w2 == $img_h2) {
        $newwidth = $img_w2 * 1.52;
        $newheight = $img_h2 * 1.52;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 57 && $img_w4 == $img_h4) {
        $newwidth = $img_w4 * 1.58;
        $newheight = $img_h4 * 1.58;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 57 && $img_w5 == $img_h5) {
        $newwidth = $img_w5 * 1.58;
        $newheight = $img_h5 * 1.58;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 57 && $img_w6 == $img_h6) {
        $newwidth = $img_w6 * 1.52;
        $newheight = $img_h6 * 1.52;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 57 && $img_w7 == $img_h7) {
        
        $newwidth = $img_w7 * 1.58;
        $newheight = $img_h7 * 1.58;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        ...
        imagejpeg($thumb, $new_image7);
       
    }else if ($f_id == 58 && $img_w7 == $img_h7) {
        $newwidth = $img_w7 * 1.1;
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 57 && $img_w8 == $img_h8) {
        $newwidth = $img_w8 * 1.58;
        $newheight = $img_h8 * 1.58;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
...
if ($process['result'] && $image->save_folder) {
    ...
    $box10_height = intval($box_height10 / 4);
     if ($f_id == 57 && $img_w10 == $img_h10) {
        
        $newwidth = $img_w10 * 1.58;
        $newheight = $img_h10 * 1.58;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
        ...
        imagejpeg($thumb, $new_image10);
       
    }else if ($f_id == 58 && $img_w10 == $img_h10) {
        $newwidth = $img_w10 * 1.1;
...
if ($process['result'] && $image->save_folder) {
    ...
    if ($f_id == 56 && $img_w1 == $img_h1) {
        ...
        // Output
        imagejpeg($thumb, '../frames_resize/' . $new_image1);
    }else if ($f_id == 58 && $img_w11 < $img_h11) {
        
        $newwidth = $img_w11 * 1.38;
        $newheight = $img_h11 * 1.38;
        // Load
        $thumb = imagecreatetruecolor($newwidth, $newheight);
    ...
    if (isset($_POST['slot_2_de']) && ($_POST['slot_2_de'] != "")) {
        ...
        if ($pos_w2 > ($pos_w2 / 2)) {
            ...
            if ($image_h2 == $image_w2) {
                $pos_w2 = $slot_2_de[0] * 0.85;
            }
            //width greater
            if ($image_h2 < $image_w2) {
                $pos_w2 = $slot_2_de[0] * 0.95;
            }
        }
        //height
        if ($pos_h2 > ($pos_h2 / 2)) {
    ...
    if (isset($_POST['slot_6_de']) && ($_POST['slot_6_de'] != "")) {
        ...
        if ($pos_w6 > ($pos_w6 / 2)) {
            ...
            if ($image_h6 == $image_w6) {
                $pos_w6 = $slot_6_de[0] * 0.85;
            }
            //width greater
            if ($image_h6 < $image_w6) {
                $pos_w6 = $slot_6_de[0] * 0.95;
            }
        }
        //height
        if ($pos_h6 > ($pos_h6 / 2)) {
    ...
    if (isset($_POST['slot_11_de']) && ($_POST['slot_11_de'] != "")) {
        ...
        if ($pos_w11 > ($pos_w11 / 2)) {
            ...
            if ($image_h11 == $image_w11) {
                $pos_w11 = $slot_11_de[0] * 3.9;
            }
            //width greater
            if ($image_h11 < $image_w11) {
                $pos_w11 = $slot_11_de[0] * 1.5;
            }
        }
        //height
...
if ($f_id == '57') {
    ...
    if (isset($_POST['slot_4_de']) && ($_POST['slot_4_de'] != "")) {
        ...
        if ($pos_w4 > ($pos_w4 / 2)) {
            list($image_w4, $image_h4) = getimagesize($new_image4);
            if ($image_h4 == $image_w4) {
                $pos_w4 = $slot_4_de[0] * 0.85;
            }
            //width greater
            if ($image_h4 < $image_w4) {
                $pos_w4 = $slot_4_de[0] * 0.95;
            }
        }
        //height
        if ($pos_h4 > ($pos_h4 / 2)) {
    ...
    if (isset($_POST['slot_5_de']) && ($_POST['slot_5_de'] != "")) {
        ...
        if ($pos_w5 > ($pos_w5 / 2)) {
            list($image_w5, $image_h5) = getimagesize($new_image5);
            if ($image_h5 == $image_w5) {
                $pos_w5 = $slot_5_de[0] * 0.85;
            }
            //width greater
            if ($image_h5 < $image_w5) {
                $pos_w5 = $slot_5_de[0] * 0.95;
            }
        }
        //height
        if ($pos_h5 > ($pos_h5 / 2)) {
    ...
    if (isset($_POST['slot_7_de']) && ($_POST['slot_7_de'] != "")) {
        ...
        if ($pos_w7 > ($pos_w7 / 2)) {
            list($image_w7, $image_h7) = getimagesize($new_image7);
            if ($image_h7 == $image_w7) {
                $pos_w7 = $slot_7_de[0] * 0.85;
            }
            //width greater
            if ($image_h7 < $image_w7) {
                $pos_w7 = $slot_7_de[0] * 0.95;
            }
        }
        //height
        if ($pos_h7 > ($pos_h7 / 2)) {
    ...
    if (isset($_POST['slot_8_de']) && ($_POST['slot_8_de'] != "")) {
        ...
        if ($pos_w8 > ($pos_w8 / 2)) {
            list($image_w8, $image_h8) = getimagesize($new_image8);
            if ($image_h8 == $image_w8) {
                $pos_w8 = $slot_8_de[0] * 0.85;
            }
            //width greater
            if ($image_h8 < $image_w8) {
                $pos_w8 = $slot_8_de[0] * 0.95;
            }
        }
        //height
        if ($pos_h8 > ($pos_h8 / 2)) {
    ...
    if (isset($_POST['slot_10_de']) && ($_POST['slot_10_de'] != "")) {
        ...
        if ($pos_w10 > ($pos_w10 / 2)) {
            list($image_w10, $image_h10) = getimagesize($new_image10);
            if ($image_h10 == $image_w10) {
                $pos_w10 = $slot_10_de[0] * 0.85;
            }
            //width greater
            if ($image_h10 < $image_w10) {
                $pos_w10 = $slot_10_de[0] * 0.95;
            }
        }
        //height
        if ($pos_h10 > ($pos_h10 / 2)) {
            ...
            //graeter
            if ($image_h10 > $image_w10) {
                $pos_h10 = $pos_h10 * 1.52;
            }
            //equal
            if ($image_h10 == $image_w10) {
                $pos_h10 = $pos_h10 * 0.97;
            }
        }
    } else {
        list($image_w10, $image_h10) = getimagesize($new_image10);
    ...
    if (isset($_POST['slot_11_de']) && ($_POST['slot_11_de'] != "")) {
        ...
        if ($pos_w11 > ($pos_w11 / 2)) {
            list($image_w11, $image_h11) = getimagesize($new_image11);
            if ($image_h11 == $image_w11) {
                $pos_w11 = $slot_11_de[0] * 1.35;
            }
            //width greater
            if ($image_h11 < $image_w11) {
                $pos_w11 = $slot_11_de[0] * 1.36;
            }
        }
        //height
        if ($pos_h11 > ($pos_h11 / 2)) {
...
if ($f_id == '58') {
    ...
    if (isset($_POST['slot_11_de']) && ($_POST['slot_11_de'] != "")) {
        ...
        if ($pos_w11 > ($pos_w11 / 2)) {
            list($image_w11, $image_h11) = getimagesize($new_image11);
            if ($image_h11 == $image_w11) {
                $pos_w11 = $slot_11_de[0] * 2.2;
            }
            //width greater
            if ($image_h11 < $image_w11) {
                $pos_w11 = $slot_11_de[0] * 2.1;
            }
        }
        //height
        if ($pos_h11 > ($pos_h11 / 2)) {
